...
sed -i "s|CONTRACT_ADDR=.*|CONTRACT_ADDR=$(cat .contract)|g" ./web/.env && \
sed -i "s|OWNER_ADDR=.*|OWNER_ADDR=$(cat .ownerAddress)|g" ./web/.env && \
sed -i "s|ADMIN_ADDR=.*|ADMIN_ADDR=$(cat .adminAddress)|g" ./web/.env;
